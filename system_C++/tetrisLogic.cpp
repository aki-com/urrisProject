...
bool Tetris_Game::initializeField() {
    ...
    field_in.block(0, 0, FIELD_H_in, FIELD_WALL).setOnes(); // 左側の壁
    field_in.block(0, FIELD_W_in - FIELD_WALL, FIELD_H_in, FIELD_WALL).setOnes(); // 右側の壁
    field_in.bottomRows(FIELD_WALL).setOnes(); // 底の壁
    field_read();
